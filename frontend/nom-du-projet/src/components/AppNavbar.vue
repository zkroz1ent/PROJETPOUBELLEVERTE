  ...
  <nav class="bg-gray-800 p-2">
    <div class="container mx-auto flex justify-between items-center">
      ...
      <ul class="flex space-x-4">
        <li><router-link to="/login" class="text-white hover:text-gray-400">Login</router-link></li>
        <li><router-link to="/signup" class="text-white hover:text-gray-400">Sign Up</router-link></li>
        <li v-if="isCyclist"><router-link to="/cyclist/trajets" class="text-white hover:text-gray-400">Mes Trajets</router-link></li>
